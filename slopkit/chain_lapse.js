...
var detEl = document.getElementById("UA");
detEl.innerText += " " + navigator.userAgent;
...
(async function () {
    ...
    try {
        ...
        let payload = null;
        try {
            const prsp = await fetch("../payloads/goldhen.bin");
                ...
                if (pipeM && pipeS) {
                    ...
                    if (preflightOk) try {
                            ...
                            if (shaped) {
                                ...
                                if (!payload) {
                                    mark("PAYLOAD-NONE", "goldhen.bin was not loaded");
                                }
